...
export const loadUsers = createAction('[Consumer/API] Load Users', props<{ query: string }>());
export const loadUsersSuccess = createAction('[Consumer/API] Load Users Success', props<{ users: User[] }>());
